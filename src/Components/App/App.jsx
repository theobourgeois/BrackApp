...
function App() {
  ...
  const [contenderCount, setContenderCount] = useState(localStorage.getItem("contenderCount"))
  ...
  const [leftRounds, setLeftRounds] = useState(
    JSON.parse(localStorage.getItem("leftRounds"))
  );
  const [rightRounds, setRightRounds] = useState(
    JSON.parse(localStorage.getItem("rightRounds"))
  );
  const [finalRound, setFinalRound] = useState(JSON.parse(localStorage.getItem("finalRound")))
